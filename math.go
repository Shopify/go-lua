...
func _ldexp(l State) int {
	x, e := CheckNumber(l, 1), CheckInteger(l, 2)
	l.PushNumber(math.Ldexp(x, e))
	return 1
}

func mathReduce(f func(float64, float64) float64) Function {
	return func(l State) int {
...
func _random(l State) int {
	...
	default:
		Error(l, "wrong number of arguments")
	}
	return 1
}

func _randomseed(l State) int {
...
var mathLibrary = []RegistryFunction{
	...
	{"ldexp", _ldexp},
	{"log", _log},
	{"max", mathReduce(math.Max)},
	{"min", mathReduce(math.Min)},
	{"modf", _modf},
